...
CREATE TABLE `t_channel` (
  ...
  `title` varchar(30) CHARACTER SET latin1 NOT NULL COMMENT '频道名称',
  `description` varchar(255) CHARACTER SET latin1 NOT NULL COMMENT '频道描述',
  `slug` varchar(50) CHARACTER SET latin1 NOT NULL COMMENT '英文简写',
  `cover_img` varchar(100) CHARACTER SET latin1 DEFAULT NULL COMMENT '频道封面图',
  ...
  `hosts` varchar(255) CHARACTER SET latin1 NOT NULL DEFAULT '' COMMENT '频道主持 多个id以逗号分隔',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_post` (
  ...
  `ua` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `t_tag` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(30) CHARACTER SET latin1 NOT NULL COMMENT '标签名称',
  `slug` varchar(30) CHARACTER SET latin1 NOT NULL COMMENT '英文简写',
...
CREATE TABLE `t_topic` (
  ...
  `author` varchar(60) CHARACTER SET latin1 NOT NULL DEFAULT '' COMMENT '作者用户名',
...
CREATE TABLE `t_user` (
  ...
  `url` varchar(100) CHARACTER SET latin1 NOT NULL DEFAULT '' COMMENT '用户个人主页',
